...
## input.txt 
Each command line flag specifies the execution of different fucntions with certain arguments. Format should be "Filename:wave_ids" or "Directory:wave_ids". If you want all wave_ids analyzed then just include the "filename".
